    ...
    <div v-else>
      ...
      <div v-if="caseList.length" class="case-cont">
        <div class="case-cont-item">
          <span class="item-label">案例标题：</span>
          <span class="item-info">{{ caseInfo.title }}</span>
        </div>
        <div class="case-cont-item">
          <span class="item-label">案例封面：</span>
          <img class="item-info" :src="caseInfo.img" @error="notFoundPic" />
        </div>
        <div class="case-cont-item">
