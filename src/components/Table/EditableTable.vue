                ...
                <td v-for="(th, i) in title" :key="i" :align="th.align">
                    ...
                    <div v-if="th.type == 'UploadImg'">
                        ...
                        <div class="upload-btn">
                            <Button type="ghost" :disabled="item[th.key] == ''" icon="ios-eye-outline" @click="uploadClick">查看图片</Button>
                            <Button type="ghost" icon="ios-cloud-upload-outline" @click="uploadClick" style="margin-left:10px">上传图片</Button>
